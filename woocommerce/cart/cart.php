	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-price"><?php esc_html_e( 'Upfront Price', 'woocommerce' ); ?> <span style="font-size:12px; font-weight: normal">(excl. VAT)</span></th>
				<th class="product-quantity"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></th>
				<th class="product-subtotal"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?> <span style="font-size:12px; font-weight: normal">(excl. VAT)</span></th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				<td colspan="6" class="actions">
					...
					<a href="/shop/" class="btn btn-outline-primary"><?php esc_html_e( 'Add product', 'woocommerce' ); ?></a>
