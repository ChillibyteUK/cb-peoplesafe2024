...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s="tab",o=".bs.tab",r=`hide${o}`,a=`hidden${o}`,l=`show${o}`,c=`shown${o}`,u=`click${o}`,d=`keydown${o}`,h=`load${o}`,f="ArrowLeft",p="ArrowRight",g="ArrowUp",m="ArrowDown",_="Home",b="End",v="active",y="fade",w="show",E="dropdown",A=".dropdown-toggle",x=".dropdown-menu",T=`:not(${A})`,O='.list-group, .nav, [role="tablist"]',C=".nav-item, .list-group-item",L='[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',k=`.nav-link${T}, .list-group-item${T}, [role="tab"]${T}, ${L}`,S=`.${v}[data-bs-toggle="tab"], .${v}[data-bs-toggle="pill"], .${v}[data-bs-toggle="list"]`;class D extends e{constructor(e){super(e),this._parent=this._element.closest(O),this._parent&&(this._setInitialAttributes(this._parent,this._getChildren()),t.on(this._element,d,(e=>this._keydown(e))))}static get NAME(){return s}show(){const e=this._element;if(this._elemIsActive(e))return;const n=this._getActiveElem(),i=n?t.trigger(n,r,{relatedTarget:e}):null;t.trigger(e,l,{relatedTarget:n}).defaultPrevented||i&&i.defaultPrevented||(this._deactivate(n,e),this._activate(e,n))}_activate(e,i){if(!e)return;e.classList.add(v),this._activate(n.getElementFromSelector(e));const s=()=>{"tab"===e.getAttribute("role")?(e.removeAttribute("tabindex"),e.setAttribute("aria-selected",!0),this._toggleDropDown(e,!0),t.trigger(e,c,{relatedTarget:i})):e.classList.add(w)};this._queueCallback(s,e,e.classList.contains(y))}_deactivate(e,i){if(!e)return;e.classList.remove(v),e.blur(),this._deactivate(n.getElementFromSelector(e));const s=()=>{"tab"===e.getAttribute("role")?(e.setAttribute("aria-selected",!1),e.setAttribute("tabindex","-1"),this._toggleDropDown(e,!1),t.trigger(e,a,{relatedTarget:i})):e.classList.remove(w)};this._queueCallback(s,e,e.classList.contains(y))}_keydown(e){if(![f,p,g,m,_,b].includes(e.key))return;e.stopPropagation(),e.preventDefault();const t=this._getChildren().filter((e=>!i.isDisabled(e)));let n;if([_,b].includes(e.key))n=t[e.key===_?0:t.length-1];else{const s=[p,m].includes(e.key);n=i.getNextActiveElement(t,e.target,s,!0)}n&&(n.focus({preventScroll:!0}),D.getOrCreateInstance(n).show())}_getChildren(){return n.find(k,this._parent)}_getActiveElem(){return this._getChildren().find((e=>this._elemIsActive(e)))||null}_setInitialAttributes(e,t){this._setAttributeIfNotExists(e,"role","tablist");for(const e of t)this._setInitialAttributesOnChild(e)}_setInitialAttributesOnChild(e){e=this._getInnerElement(e);const t=this._elemIsActive(e),n=this._getOuterElement(e);e.setAttribute("aria-selected",t),n!==e&&this._setAttributeIfNotExists(n,"role","presentation"),t||e.setAttribute("tabindex","-1"),this._setAttributeIfNotExists(e,"role","tab"),this._setInitialAttributesOnTargetPanel(e)}_setInitialAttributesOnTargetPanel(e){const t=n.getElementFromSelector(e);t&&(this._setAttributeIfNotExists(t,"role","tabpanel"),e.id&&this._setAttributeIfNotExists(t,"aria-labelledby",`${e.id}`))}_toggleDropDown(e,t){const i=this._getOuterElement(e);if(!i.classList.contains(E))return;const s=(e,s)=>{const o=n.findOne(e,i);o&&o.classList.toggle(s,t)};s(A,v),s(x,w),i.setAttribute("aria-expanded",t)}_setAttributeIfNotExists(e,t,n){e.hasAttribute(t)||e.setAttribute(t,n)}_elemIsActive(e){return e.classList.contains(v)}_getInnerElement(e){return e.matches(k)?e:n.findOne(k,e)}_getOuterElement(e){return e.closest(C)||e}static jQueryInterface(e){return this.each((function(){const t=D.getOrCreateInstance(this);if("string"==typeof e){if(void 0===t[e]||e.startsWith("_")||"constructor"===e)throw new TypeError(`No method named "${e}"`);t[e]()}}))}}return t.on(document,u,L,(function(e){["A","AREA"].includes(this.tagName)&&e.preventDefault(),i.isDisabled(this)||D.getOrCreateInstance(this).show()})),t.on(window,h,(()=>{for(const e of n.find(S))D.getOrCreateInstance(e)})),i.defineJQueryPlugin(D),D}(O(),m(),$(),g())}({get exports(){return an},set exports(e){an=e}});var ln=an,cn={};
/*!
	  * Bootstrap toast.js v5.3.3 (https://getbootstrap.com/)
	  * Copyright 2011-2024 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s="toast",o=".bs.toast",r=`mouseover${o}`,a=`mouseout${o}`,l=`focusin${o}`,c=`focusout${o}`,u=`hide${o}`,d=`hidden${o}`,h=`show${o}`,f=`shown${o}`,p="fade",g="hide",m="show",_="showing",b={animation:"boolean",autohide:"boolean",delay:"number"},v={animation:!0,autohide:!0,delay:5e3};class y extends e{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return v}static get DefaultType(){return b}static get NAME(){return s}show(){if(t.trigger(this._element,h).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(p);const e=()=>{this._element.classList.remove(_),t.trigger(this._element,f),this._maybeScheduleHide()};this._element.classList.remove(g),i.reflow(this._element),this._element.classList.add(m,_),this._queueCallback(e,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(t.trigger(this._element,u).defaultPrevented)return;const e=()=>{this._element.classList.add(g),this._element.classList.remove(_,m),t.trigger(this._element,d)};this._element.classList.add(_),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(m),super.dispose()}isShown(){return this._element.classList.contains(m)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const n=e.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){t.on(this._element,r,(e=>this._onInteraction(e,!0))),t.on(this._element,a,(e=>this._onInteraction(e,!1))),t.on(this._element,l,(e=>this._onInteraction(e,!0))),t.on(this._element,c,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=y.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return n.enableDismissTrigger(y),i.defineJQueryPlugin(y),y}(O(),m(),I(),g())}({get exports(){return cn},set exports(e){cn=e}});var un,dn,hn,fn=cn;un=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,dn=navigator.userAgent.toLowerCase().indexOf("opera")>-1,hn=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(un||dn||hn)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1),AOS.init({duration:600,easing:"ease-in-out",once:!0}),document.addEventListener("DOMContentLoaded",(function(){const e=new IntersectionObserver(((e,t)=>{e.forEach((e=>{e.isIntersecting&&(e.target.classList.add("aos-animate"),t.unobserve(e.target))}))}),{rootMargin:"0px 0px -125px 0px"});document.querySelectorAll(".aos-init").forEach((t=>{e.observe(t)}));const t=document.querySelectorAll(".toggle"),n=document.getElementById("burger-menu"),i=document.getElementById("navItems"),s=document.getElementById("navMenus"),o=document.querySelector("nav"),r=document.querySelector("header"),a=document.querySelector(".navbar__extras");function l(e){const t=e.querySelector(".left > li");if(t){t.classList.add("active");const n=t.parentElement.children;for(const e of n)e!==t&&e.classList.remove("active");const i=t.getAttribute("aria-controls");if(e.querySelectorAll(".right").forEach((e=>e.classList.remove("active"))),i){const e=document.getElementById(i);if(e){e.classList.add("active");const t=e.parentElement.children;for(const n of t)n!==e&&n.classList.remove("active")}}}}function c(){const e=window.innerWidth;t.forEach((t=>{if(e>=1200)t.addEventListener("click",u),t.setAttribute("href","javascript:void(0);");else{t.removeEventListener("click",u);const e=t.getAttribute("data-href");t.setAttribute("href",e)}}))}function u(e){if("link"===e.currentTarget.getAttribute("aria-controls")){const t=e.currentTarget.getAttribute("data-href");return void(t&&(window.location.href=t))}e.preventDefault(),e.stopPropagation();const t=e.currentTarget.getAttribute("aria-controls"),n=document.getElementById(t),i=n.classList.contains("active"),s=document.querySelectorAll(".dropdownMenu"),o=document.querySelectorAll(".toggle");s.forEach((e=>e.classList.remove("active"))),o.forEach((e=>e.classList.remove("active"))),i?l(n):(e.currentTarget.classList.add("active"),n.classList.add("active"))}function d(e){const t=document.querySelectorAll(`#${e} .left > li`);t.forEach((n=>{n.addEventListener("click",(function(){t.forEach((e=>e.classList.remove("active"))),n.classList.add("active");const i=n.getAttribute("aria-controls");document.querySelectorAll(`#${e} .right`).forEach((e=>e.classList.remove("active"))),document.getElementById(i).classList.add("active")}))}))}n&&i&&s&&n.addEventListener("click",(function(){o.classList.toggle("active"),i.classList.toggle("active"),s.classList.toggle("active"),a.classList.toggle("active"),n.classList.toggle("open")})),c(),window.addEventListener("resize",c),window.addEventListener("scroll",(function(){window.scrollY>100?r.classList.add("scrolled"):r.classList.remove("scrolled")})),document.addEventListener("click",(function(e){const t=document.querySelector(".dropdownMenu.active");if(t&&!t.contains(e.target)){const e=document.querySelector(".toggle.active");e&&e.classList.remove("active"),t.classList.remove("active"),l(t)}})),d("dropdownSolutions"),d("dropdownProducts");document.querySelectorAll("section").forEach((e=>{const t=e.querySelectorAll(".pill"),n=e.querySelectorAll(".content");t.forEach((i=>{i.addEventListener("click",(function(){t.forEach((e=>e.classList.remove("active"))),i.classList.add("active");const s=i.getAttribute("aria-controls");n.forEach((e=>e.classList.remove("active"))),e.querySelector(`#${s}`).classList.add("active")}))}))}))})),e.Alert=P,e.Button=M,e.Carousel=W,e.Collapse=V,e.Dropdown=Lt,e.Modal=Bt,e.Offcanvas=Vt,e.Popover=sn,e.Scrollspy=rn,e.Tab=ln,e.Toast=fn,e.Tooltip=nn}));
