...
// add_filter('use_block_editor_for_post', '__return_true'); // DO NOT USE WITH WOOCOMMERCE
...
function cb_theme_enqueue() {
    ...
    wp_enqueue_script( 'jquery', get_stylesheet_directory_uri() . '/js/jquery.min.js', array(), null, true ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
    wp_enqueue_style( 'slick-styles', get_stylesheet_directory_uri() . '/css/slick.min.css', array(), true ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
    ...
    wp_enqueue_style( 'swiper-style', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/11.0.5/swiper-bundle.min.css', array() ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
    wp_enqueue_script( 'swiper', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/11.0.5/swiper-bundle.min.js', array(), null, true ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
